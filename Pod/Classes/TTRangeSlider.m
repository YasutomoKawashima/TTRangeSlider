...
//    CGPoint leftHandleCentre = [self getCentreOfRect:self.leftHandle.frame];
    CGPoint leftHandleCentre = CGPointMake([self getXPositionAlongLineForValue:self.minValue], CGRectGetMidY(self.sliderLine.frame));
...
//    CGPoint rightHandleCentre = [self getCentreOfRect:self.rightHandle.frame];
    CGPoint rightHandleCentre = CGPointMake([self getXPositionAlongLineForValue:self.maxValue], CGRectGetMidY(self.sliderLine.frame));
